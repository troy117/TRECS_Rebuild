...
INSERT OR IGNORE INTO products (name, category, size, requires_image, metadata_json) VALUES
  ...
  ('Event 5x7', 'event_item', '5x7', 1, '{"event_render":"5x7","description":"Event render card, separate from regular portrait units"}'),
  ('Event 4 Wallets', 'event_item', 'wallet', 1, '{"event_render":"wallets","description":"Event render card with four wallets"}'),
  ('Event Digital Download', 'event_item', NULL, 1, '{"event_render":"digital_download","description":"Event render card with digital download QR code"}'),
