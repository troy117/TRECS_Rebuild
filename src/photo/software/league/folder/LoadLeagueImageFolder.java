...
public class LoadLeagueImageFolder 
{
	...
	public LoadLeagueImageFolder(JobData job,LeagueGUI leagueGUI, String schoolPath)
	{
	...
	{
		ArrayList<LeaguePlayer> players = new ArrayList<LeaguePlayer>();
		LeaguePlayer temp;
		for(int i=0;i<inputData.size();i++)
		{
			temp = new LeaguePlayer(inputData.get(i)[0],inputData.get(i)[1],inputData.get(i)[2],inputData.get(i)[3],
					inputData.get(i)[4],inputData.get(i)[5]);
			players.add(temp);
		}
		return leagueGUI.updateDatabase(players);
	}
