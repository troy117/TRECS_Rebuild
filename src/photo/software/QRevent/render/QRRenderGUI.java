...
public class QRRenderGUI extends JInternalFrame implements ActionListener
{
	...
	public QRRenderGUI(QREventGUI eventGUI) 
	{
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		else if(pressed == btnRenderAll)
		{
			...
			else
			{
				...
				{
					RenderQREvent render = new RenderQREvent(eventGUI,students, eventGUI.schoolPath,
				...
				{
					RenderQREvent2 render = new RenderQREvent2(eventGUI,students, eventGUI.schoolPath,
		...
		else if(pressed == btnRenderSelectedIn)
		{
			...
			else
			{
				if(chckbxxFormat.isSelected())
				{
					RenderQREvent render = new RenderQREvent(eventGUI,eventGUI.getSelectedStudents(), eventGUI.schoolPath,
							outputFolder.getAbsolutePath(),comboBox.getSelectedIndex(),comboBox_1.getSelectedIndex(),this,chckbxRenderOutLabels.isSelected(),chckbxIncludeIsland.isSelected(),chckbxDownload.isSelected());
					renderThread = new Thread(render);
					renderThread.start();
				}
				...
				{
					RenderQREvent2 render = new RenderQREvent2(eventGUI,eventGUI.getSelectedStudents(), eventGUI.schoolPath,
							outputFolder.getAbsolutePath(),comboBox.getSelectedIndex(),comboBox_1.getSelectedIndex(),this,chckbxRenderOutLabels.isSelected(),chckbxIncludeIsland.isSelected());
					renderThread = new Thread(render);
					renderThread.start();
				}
