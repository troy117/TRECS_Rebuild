...
contextBridge.exposeInMainWorld('trecs', {
  ...
  applyRosterVerification: (jobId, input) => ipcRenderer.invoke('roster-verification:apply', jobId, input),
  getDuplicateRecordReview: (jobId) => ipcRenderer.invoke('duplicate-records:get', jobId),
  markDuplicateRecordReviewed: (jobId, input) => ipcRenderer.invoke('duplicate-records:mark-reviewed', jobId, input),
  getStaffVerificationSetup: (jobId) => ipcRenderer.invoke('staff-verification:get', jobId),
  saveStaffVerification: (jobId, rows) => ipcRenderer.invoke('staff-verification:save', jobId, rows),
